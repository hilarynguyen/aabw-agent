...
def run_match(sb, user_id: str, count: int = 4) -> List[dict]:
    """Embed the user's profile_text and call the pgvector RPC; return MatchCandidate dicts."""
    ...
    my_skills = {s.lower() for s in (me.get("skills") or [])}
    out: List[dict] = []
